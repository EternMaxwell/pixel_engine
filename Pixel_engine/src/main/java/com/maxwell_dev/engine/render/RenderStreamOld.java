 ...
 */
public class RenderStreamOld extends Stream{
     ...
     */
    public RenderStreamOld(DrawPipeline pipeline, long vertexBufferSize, long indexBufferSize, long indirectBufferSize, boolean resetEachPass){
