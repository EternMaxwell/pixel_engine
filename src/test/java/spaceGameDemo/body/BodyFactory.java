...
public class BodyFactory {
    public static Set<SpaceBody> randomAstroid(int size_expect, float x, float y, float angle, List<Vec2> verticesRetriever){
        ...
        for(BodyElement[][] sub: Util.mesh.split(grid, BodyElement[][]::new, BodyElement[]::new)){
            SpaceBody body = new SpaceBody(sub, x, y, angle, verticesRetriever==null?null: new ArrayList<>());
            bodies.add(body);
        }
        return bodies;
    }
